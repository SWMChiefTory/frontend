...
// 1. 기본 카드 컴포넌트
export function NormalCategoryCard({
  category,
  onPress,
  onDelete,
        ...
        <View style={baseStyles.content}>
          ...
          >
            <Ionicons
              name="folder"
              size={20}
              color={isReceiving ? COLORS.text.white : COLORS.orange.main}
            />
          </View>
          <Text
            style={[
          ...
          <Text style={[baseStyles.count, { color: COLORS.orange.main }]}>
            {category.count}개
          </Text>
        </View>
        {/* 드래그 가이드 오버레이 */}
...
// 3. 삭제 중인 카드
export function DeletingCategoryCard({
  category,
}: Pick<BaseProps, "category">) {
  ...
  return (
    ...
    >
      ...
      >
        <View style={baseStyles.content}>
          <View
            style={[baseStyles.iconContainer, { backgroundColor: "#F5F5F5" }]}
          >
            <Ionicons name="folder" size={20} color={COLORS.text.gray} />
          </View>
          <Text
            style={[baseStyles.name, { color: COLORS.text.gray, opacity: 0.6 }]}
            numberOfLines={1}
          >
            {category.name}
          </Text>
          <Text style={[baseStyles.count, { opacity: 0.6 }]}>
            {category.count}개
          </Text>
        </View>
        ...
        >
          ...
          />
          <Text style={{ fontSize: 11, color: "#FF6B6B", fontWeight: "700" }}>
            삭제 중...
          </Text>
        </View>
      </View>
...
// 4. 업데이트 중인 카드
export function UpdatingCategoryCard({
  category,
}: Pick<BaseProps, "category">) {
  const scaleAnim = useRef(new Animated.Value(1)).current;
  ...
  return (
    ...
    >
      ...
      >
        <View style={baseStyles.content}>
          <View
            style={[baseStyles.iconContainer, { backgroundColor: "#E3F2FD" }]}
          >
            <Ionicons name="folder" size={20} color="#3498DB" />
          </View>
          <Text
            style={[baseStyles.name, { color: "#3498DB", fontWeight: "600" }]}
            numberOfLines={1}
          >
            {category.name}
          </Text>
          <Text style={[baseStyles.count, { color: "#3498DB" }]}>
            {category.count}개
          </Text>
        </View>
        ...
        >
          <ActivityIndicator
            ...
            style={{ marginBottom: 4 }}
          />
          <Text style={{ fontSize: 11, color: "#3498DB", fontWeight: "700" }}>
            업데이트 중...
          </Text>
        </View>
      </View>
...
export function CategoryCard({
  ...
  if (
    categoryState === CategoryState.DRAGGING &&
    categorySelectedState === CategorySelectedState.UNSELECTED
  ) {
    return <DroppableCategoryCard category={category} onDrop={onDrop} />;
  }
