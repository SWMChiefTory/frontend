...
import { Gender,getGenderLabel,getGenderIconName } from '@/src/modules/login/enums/Gender';
...
export const GenderOptions = ({genderSelected, setGender}: {genderSelected: Gender, setGender: (gender: Gender) => void}) => {
        ...
        <View style={styles.genderContainer}>
            ...
            <View style={styles.genderOptions}>
                {optionValues.map(optionValue => (
                    <GenderOption key={optionValue.genderValue} {...optionValue} genderSelected={genderSelected} setGender={setGender} />
                ))}
            </View>
        </View>
    )
...
const GenderOption = ({genderSelected, setGender, genderValue, label, icon }:
     { genderSelected: Gender, setGender: (gender: Gender) => void,
         genderValue: Gender, label: string, icon: IoniconsName  }) => (
    <TouchableOpacity
      style={[
        styles.genderCard,
