...
export function extractAxiosErrorInfo(err: AxiosError<ErrorData>) : ErrorResponse {
    ...
    return {code: err.response.status, message: response.data.message, error: response.data.error};
}