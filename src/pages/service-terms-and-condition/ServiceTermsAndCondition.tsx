    ...
    },
    {
      ...
      subsections: [
        ...
        },
        {
          number: 3,
          content:
            "회사는 이용자에게 통지를 미지데, 법적 요 미소정, 오기재 등으로 인하여 개별 통지가 어려운 경우에 한하여 전항의 공시를 함으로써 개별 통지를 한 것으로 간주합니다.",
        },
      ],
    },
    {
      ...
      subsections: [
        {
          number: 1,
          content:
            "회사는 계속적이고 안정적인 서비스의 제공을 위하여 설비에 장애가 생기거나 멸실된 때에는 이를 지체 없이 수리 또는 복구하며, 다음 각 호의 사유 발생 시 부득이한 경우 예고 없이 서비스의 전부 또는 일부의 제",
        },
      ],
    },
  ],
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.effectiveDate}>제1조(시행일)</Text>
