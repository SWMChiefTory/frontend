            ...
            <View style={{ overflow: 'visible', position: 'relative' }}>
              ...
              <Pressable
                ...
                style={{
                  ...
                  height: 40,
                  borderRadius: 20,
                  backgroundColor: isFirstStep ? 'rgba(0,0,0,0.15)' : 'rgba(0,0,0,0.4)',
                  alignItems: 'center',
                  justifyContent: 'center',
                }}
              >
                <Ionicons name="chevron-up" size={20} color={isFirstStep ? 'rgba(255,255,255,0.3)' : '#fff'} />
              </Pressable>
            </View>
