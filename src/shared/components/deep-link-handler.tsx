...
export function DeepLinkHandler() {
  ...
  useEffect(() => {
    ...
    // enableDynamicSizing은 컨텐츠 레이아웃 측정이 끝나야 expand() 가능.
    // cold start에서는 측정 완료까지 대기 필요.
  ...
  return (
    ...
    >
      <BottomSheetView
        style={{ padding: spacing.xl, gap: spacing.lg, alignItems: "center" }}
      >
        <View
          style={{
            width: 56,
