...
export const MOCK_THEME_CARDS: ThemeCard[] = [
  { id: '1', title: '두바이 초콜릿', subtitle: '달콤한 피스타치오', backgroundColor: '#5C3D2E' },
  { id: '2', title: '버터떡', subtitle: '바삭한 한입 간식', backgroundColor: '#D4A017' },
  { id: '3', title: '봄동 비빔밥', subtitle: '제철 봄나물 요리', backgroundColor: '#4A7C59' },
